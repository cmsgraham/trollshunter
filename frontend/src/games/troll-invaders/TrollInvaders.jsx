  ...
  return (
    <div className="ti-wrapper" ref={wrapperRef}>
      <div className="ti-topbar">
        <button className="ti-back" aria-label="Back"
          onTouchEnd={e => { e.stopPropagation(); e.preventDefault(); navigate('/games') }}
          onClick={() => navigate('/games')}>
          <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
            <path d="M7.414 13l5.043 5.04-1.414 1.42L3.586 12l7.457-7.46 1.414 1.42L7.414 11H21v2H7.414z"/>
          </svg>
        </button>
        <button className="ti-mute" aria-label="Mute"
          onTouchEnd={e => { e.stopPropagation(); e.preventDefault(); if (gameRef.current) gameRef.current.toggleMute() }}
          onClick={handleMute}>
          <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
